...
{
    public class DownloadMessageInfo : IMessageInfo
    {
    ...
    public class DownloadMessageInfoContainer : IMessageInfoContainer
    {
        // Changed the type to List<DownloadMessageInfo> to allow proper deserialization
        public List<DownloadMessageInfo> MessageInfoList { get; set; }
        ...
        List<IMessageInfo> IMessageInfoContainer.MessageInfoList
        {
            ...
            set => MessageInfoList = value.Cast<DownloadMessageInfo>().ToList();
        }
