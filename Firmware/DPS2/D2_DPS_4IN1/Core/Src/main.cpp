...
void UpdateSlotLed()
{
	...
	if(obj.get_LedState() == 0)
	{
		...
		for (itr=0;itr<4;itr++)
		{
			if(get_D2_slt_status((CartridgeID)itr) == 2)
			{
				HAL_GPIO_WritePin(GPIOA, get_D2_Green_LedPins((CartridgeID)itr)
...
int main(void)
{
  ...
  BlinkLed_PA1_PA8(300);
	...
	IspManager.setBoardID(IspBoardId::DPS2_4_IN_1);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, DB2_Pin|DB3_Pin|DB4_Pin|DB5_Pin
                          |DB6_Pin|D07_Pin|DB0_Pin|DB1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, CLE_Pin|ALE_Pin|WP_Pin|WE_Pin
                          |RE_Pin|CE1_Pin|CE2_Pin|CE3_Pin
                          |CE4_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : DB2_Pin DB3_Pin DB4_Pin DB5_Pin
                           DB6_Pin D07_Pin DB0_Pin DB1_Pin */
  ...
  /*Configure GPIO pins : RB1_Pin RB2_Pin RB3_Pin RB4_Pin
                           SLT_S1_Pin SLT_S2_Pin SLT_S3_Pin SLT_S4_Pin
                           PC8 PC9 */
  GPIO_InitStruct.Pin = RB1_Pin|RB2_Pin|RB3_Pin|RB4_Pin
                          |SLT_S1_Pin|SLT_S2_Pin|SLT_S3_Pin|SLT_S4_Pin
  ...
  /*Configure GPIO pins : CLE_Pin ALE_Pin WP_Pin WE_Pin
                           RE_Pin CE1_Pin CE2_Pin CE3_Pin
                           CE4_Pin */
  GPIO_InitStruct.Pin = CLE_Pin|ALE_Pin|WP_Pin|WE_Pin
                          |RE_Pin|CE1_Pin|CE2_Pin|CE3_Pin
                          |CE4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
