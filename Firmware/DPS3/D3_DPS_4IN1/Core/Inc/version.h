/**
 * @file version.h
 * @brief D3_DPS_4IN1 Firmware Version Management
 * @author ISquare Systems
 * @date 2025
 * 
 * This file contains the single source of truth for D3 firmware versioning.
 * Update only these values to change the D3 firmware version.
 */

#ifndef VERSION_H
#define VERSION_H

// D3 Firmware Version Components
...
#define HARDWARE_TYPE "D3_DPS_4IN1"
#define HARDWARE_DESCRIPTION "Compact Flash Programming System"
