...
enum class VennaTransportStatus {
    OK,
    ERROR,
    TIMEOUT,
    DISCONNECTED
...
public:
    ...
    virtual VennaTransportStatus status() const { return VennaTransportStatus::OK; }
    ...
    virtual ~VennaTransportInterface() = default;
};
